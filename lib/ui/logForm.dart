...
class _LogFormState extends State<LogForm> {
            ...
            children: <Widget>[
              ...
              Text(
                'Total log for the day ' +
                    this.totalHours.toStringAsFixed(1) +
                    'hours',
                textAlign: TextAlign.left,
                style: TextStyle(fontSize: 15.0),
              ),
              LogsPage(workLogs, removeData),
            ],
          ),
        ));
  }
  ...
  void _postLog() {
    ...
    Log log = Log(duration: _duration, project: _project, remarks: _remarks);
  ...
  void removeData(Log log) {
    ...
    setState(() {
      this.workLogs = workLogs;
      this.totalHours = totalHours - log.duration;
    });
  }
}
